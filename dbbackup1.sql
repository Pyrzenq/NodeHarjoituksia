...
-- Started on 2023-09-29 14:18:00
...
--
-- TOC entry 214 (class 1259 OID 19495)
...
--
-- TOC entry 221 (class 1259 OID 19534)
...
--
-- TOC entry 217 (class 1259 OID 19517)
...
--
-- TOC entry 218 (class 1259 OID 19521)
...
--
-- TOC entry 219 (class 1259 OID 19525)
...
--
-- TOC entry 220 (class 1259 OID 19529)
...
--
-- TOC entry 215 (class 1259 OID 19509)
...
CREATE VIEW public.current_prices AS
 SELECT hourly_price.timeslot AS kello,
   ...
   FROM public.hourly_price
  WHERE (hourly_price.timeslot >= '2023-09-14 00:00:00+03'::timestamp with time zone)
...
--
-- TOC entry 216 (class 1259 OID 19513)
...
--
-- TOC entry 3357 (class 0 OID 19495)
-- Dependencies: 214
...
INSERT INTO public.hourly_price VALUES ('2023-09-12 17:00:00+03', 14.1);
INSERT INTO public.hourly_price VALUES ('2023-09-14 13:00:00+03', 10.15);
INSERT INTO public.hourly_price VALUES ('2023-09-14 14:00:00+03', 10.15);
...
--
-- TOC entry 3358 (class 0 OID 19529)
-- Dependencies: 220
...
INSERT INTO public.weekday_lookup VALUES (4, 'torstai', 'torsdag', 'thursday', 'donnerstag', 'persmble');
...
--
-- TOC entry 3205 (class 2606 OID 19499)
...
--
-- TOC entry 3207 (class 2606 OID 19533)
...
-- Completed on 2023-09-29 14:18:00
